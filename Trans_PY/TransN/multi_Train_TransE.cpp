...
//private:
    ...
    vector<double> get_neighbors_attention_vec(int e, int rel, int tid)
    {
    ...
    {
	vector<double> neighbors_e1 = get_neighbors_attention_vec(e1, rel, tid);
	vector<double> neighbors_e2 = get_neighbors_attention_vec(e2, rel, tid);
        double sum=0;
        if (L1_flag)
        	for (int ii=0; ii<n; ii++)
    ...
    {
	vector<double> neighbors_e1_a = get_neighbors_attention_vec(e1_a, rel_a, tid);
	vector<double> neighbors_e2_a = get_neighbors_attention_vec(e2_a, rel_a, tid);
        vector<double> neighbors_e1_b = get_neighbors_attention_vec(e1_b, rel_b, tid);
        vector<double> neighbors_e2_b = get_neighbors_attention_vec(e2_b, rel_b, tid);
        for (int ii=0; ii<n; ii++)
        {
